import { Avatar, Badge, Button, Col, Divider, Dropdown, Empty, InputNumber, Row, Tag, Tooltip, Typography } from 'antd'
...
const HeaderCard: FC = (): JSX.Element => {
    ...
    return (
        <Col className='ml-4 flex items-center justify-center'>
                                                        ...
                                                        <Row wrap={false}>
                                                            ...
                                                            <Col flex='0 0 90px' className=''>
                                                                ...
                                                                <div
                                                                    ...
                                                                    className='pt-2 text-sm font-medium text-@dark-80 underline'
                                                                >
            ...
            >
                <Badge count={listCart.length} className='text-xs'>
